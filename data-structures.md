...
* A graph G is a set of vertices V and edges E
  ...
  ![Graph Types](assets/data-structures/gtypes.png)
...
![Sub graph](assets/data-structures/subgraph.png)
...
* Cycle: path with start and end vertex as the same.
  * How to find:
    ...
    * Whilst performing a DFS, if visiting already visited node, then it has a cycle.
    ...
    ![Path](assets/data-structures/path.png)

* Connected graph: a path exists from every node to every other node
* Tree: connected graph with no cycles
![Connected](assets/data-structures/connected.png)
...
![Components](assets/data-structures/components.png)
...
![Spanning](assets/data-structures/spanning.png)

* Clique: complete subgraph
![Clique](assets/data-structures/clique.png)


## Graph Representation
* Adjacency Matrix: |V| X |V| matrix; each cell represents an edge
![Undirected / Directed](assets/data-structures/graph_rep.png)
![Adj Matrix](assets/data-structures/graph_rep_adj.png)
 - Advantages:
   - Easy to implement
...
* Adjacency List
![Adj List](assets/data-structures/graph_rep_list.png)
...
* Representations
  ...
  * DAGs: Directed Acyclic Graph
    ...
    ![DAG](assets/data-structures/dag.png)
...
* Representations
  * Adj Matrix: store weight in each cell (not just bool)
    ![Example Weighted Adj Matrix](assets/data-structures/wgraph.png)
...
* Shortest Path Search
  ...
  - Note: If no weights we use least hops
    ![SSSP](assets/data-structures/sssp.png)
...
* best: O(n^2)
* worst: O(n^2)
![Selection sort](assets/data-structures/selection.png)
...
![Insertion sort](assets/data-structures/insertion.png)
...
![Insertion sort](assets/data-structures/shell.png)
...
![Merge sort 1](assets/data-structures/merge1.png)
![Merge sort 2](assets/data-structures/merge2.png)
...
![Quick Sort](assets/data-structures/quick_sort_partition_animation.gif)
...
* Sorting individually on each part of the key at a time:
  * digit by digit
![Radix Sort](assets/data-structures/radix.png)
...
![Rotations](assets/data-structures/rotations.png)
...
* Splay trees vary root-insertion by considering three levels of the tree
  ...
  ![Splay](assets/data-structures/splay.png)
...
* 3 Cases for rotating:
  1. (Zig-Zag) X is a left child of a right child OR X is a right child of a left child.
    ![Zig Zag](assets/data-structures/zig-zag.png)
  2. (Zig-Zig) X is a left child of a left child OR X is a right child of a right child.
    ![Zig Zig](assets/data-structures/zig-zig.png)
  3. (Zig) X is a child of the root
    ![Zig](assets/data-structures/zig.png)
...
![2-3-4 Trees](assets/data-structures/2-3-4.png)
...
* Insertion examples:
  ...
  ![insert c](assets/data-structures/insert-c.png)

  ![insert r](assets/data-structures/insert-r.png)
